...
const Videos: VideoPlay[] = [
    {
        ID: 'O7i3QAbyobc',
        title: 'LOS SIETE PROFESTAS DE LA BIBLIA'
    }
];

const Profetas: React.FC = () => {
    return (
        <IonPage>
            <IonHeader>
                <IonToolbar>
            ...
            <IonContent>
                <div style={{position: 'absolute', left: '5%', right: '5%', textAlign: 'center'}}>
                    <IonTitle color="primary"><br/>LOS SIETE PROFESTAS DE LA BIBLIA<br/></IonTitle><br/>
